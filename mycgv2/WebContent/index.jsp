	...
	<div class="content">
		<section>
			...
			<div class="s1_article">
				<article>
					<img src="http://localhost:9000/mycgv2/images/82120_320.jpg">
					<div>탑건-매버릭</div>
					<div>99%  | 예매율 37.1%</div>
				</article>
				<article>
		...
		<section>
			...
			<div class="s2_article">
				<div>
					<img src="http://localhost:9000/mycgv2/images/16390080561620.png">
				</div>
				<ul>
					<li>
		...
		<section>
			<ul>
				...
				<li>
					<img src="http://localhost:9000/mycgv2/images/16094706927780.jpg">
					<div>
