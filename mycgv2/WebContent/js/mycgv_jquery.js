$(document).ready(function(){
	...
	**********************/
	...
	/*********************
		index 페이지 효과
	**********************/
	$('.s2_article ul li').hover(function(){
		let index = $(this).index();
		const img = $(".s2_article div img");
		//alert(index);
		if(index == 0){
			img.attr("src", "http://localhost:9000/mycgv2/images/special1.png");
		}else if(index == 1){
			img.attr("src", "http://localhost:9000/mycgv2/images/special2.png");
		}else if(index == 2){
			img.attr("src", "http://localhost:9000/mycgv2/images/special3.png");
		}else if(index == 3){
			img.attr("src", "http://localhost:9000/mycgv2/images/special4.png");
		}
	})
